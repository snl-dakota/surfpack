...
from source, first obtain the distribution tarball \texttt{surfpack-0.1.tar.gz.}  From
the directory containing this file, execute the following commands:
\begin{enumerate}
\item \texttt{gunzip surfpack-0.1.tar.gz}
\item \texttt{tar xf surfpack-0.1.tar}
\item \texttt{cd surfpack-0.1}
\item \texttt{./configure}
\item \texttt{make}
\item \texttt{make install}
\end{enumerate}

Users with access to Surfpack's CVS respository may checkout the source directly
...
\begin{enumerate}
\item \texttt{cvs checkout Surfpack}
...
the \texttt{CXX} option ({\em i.e.}, \texttt{./configure CXX=g++}).  Use the \texttt{F77} to manually specify the Fortran 77 compiler.
...
\begin{figure}[htbp]
\centering \includegraphics[width=8cm]{TimingMatrixOp/kriging_times_50to3000.png}
...
with tests at invtervals of 50 points.  If the algorithm is run using $n$
...
\begin{figure}[htbp]
\centering \includegraphics[width=8cm]{TimingMatrixOp/timing_poly2.png}
...
\begin{figure}[htbp]
  ...
  \begin{bigbox}
	\begin{small}
	\verbatiminput{TestScores/sat_scores.spk}
 	\end{small}
  \end{bigbox}
...
\begin{figure}[htbp]
  ...
  \begin{bigbox}
	\begin{small}
	\verbatiminput{TestScores/sat_scores2.spk}
 	\end{small}
  \end{bigbox}
...
\begin{figure}[htbp]
  ...
  \begin{bigbox}
	\begin{small}
	\verbatiminput{MartianTopology/mars_terrain.spk}
 	\end{small}
  \end{bigbox}
   \label{fig:topology}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \begin{bigbox}
	\begin{small}
	\verbatiminput{SamplingTechniques/sampling.spk}
 	\end{small}
  \end{bigbox}
   \label{fig:sampling}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \begin{bigbox}
	\begin{small}
	\verbatiminput{FluidDynamics/cfd.spk}
 	\end{small}
  \end{bigbox}
   \label{fig:cfd}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \begin{bigbox}
	\begin{small}
	\verbatiminput{MatlabPeaks/peaks.spk}
 	\end{small}
  \end{bigbox}
   \label{fig:peaks}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \begin{bigbox}
	\begin{small}
	\verbatiminput{Engineering4D/ccd.spk}
 	\end{small}
  \end{bigbox}
   \label{fig:ccd_lhs}
\end{figure}
