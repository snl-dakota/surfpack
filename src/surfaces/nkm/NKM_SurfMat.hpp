...
inline MtxDbl& LDLT_fact(MtxDbl& matrix, MtxInt& ipvt, MtxDbl& scale, int& info, double& rcond)
{
...
inline MtxDbl& inverse_after_LDLT_fact(MtxDbl& matrix, const MtxInt& ipvt, const MtxDbl& scale)
{
  int nrows = static_cast<int>(matrix.getNRows());
  int ncols = static_cast<int>(matrix.getNCols());
#ifdef __SURFMAT_ERR_CHECK__
...
inline MtxDbl& solve_after_LDLT_fact(MtxDbl& result, const MtxDbl& ALDLT, const MtxInt& ipvt, const MtxDbl& scale, const MtxDbl& BRHS,char transB='N')
{
...
inline MtxDbl& pseudo_inverse(MtxDbl& A, double min_allowed_rcond, double& rcondA, double& log_abs_det, int& if_det_eq_zero) {
...
inline MtxDbl& pseudo_inverse_sym(MtxDbl& A, double min_allowed_rcond, double& rcond_A, double& log_abs_det_A, double& sign_of_det_A) {
  int nrowsA=A.getNRows();
#ifdef __SURFMAT_ERR_CHECK__
...
inline double log_det_after_LDLT_fact(const MtxDbl& ALDLT, const MtxInt& ipvt, const MtxDbl& scale, double& sign_of_det) {
