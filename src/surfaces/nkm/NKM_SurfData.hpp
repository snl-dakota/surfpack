...
#endif 
    double temp_double=1.0/fabs(unscaley(0,j_y));
    for(int ivarsr=0; ivarsr<nvarsr; ++ivarsr)
      temp_double*=pow(fabs(unscalexr(0,ivarsr)),der(jder,ivarsr));
    return temp_double;
  };
